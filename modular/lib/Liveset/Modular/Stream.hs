...
cv = makeF cvShape "cv"
length = makeF cvShape "length"
slew = makeF cvShape "slew"
device = makeS cvShape "device"
mul = makeF cvShape "mul"
attack = makeF cvShape "attack"
decay = makeF cvShape "decay"
atk = makeF cvShape "attack"
dcy = makeF cvShape "decay"
gain = makeF cvShape "gain"
gate = makeI cvShape "gate"
offset = makeF cvShape "offset"
curve = makeF cvShape "curve"
attack2 = makeF cvShape "attack2"
decay2 = makeF cvShape "decay2"
atk2 = makeF cvShape "attack2"
dcy2 = makeF cvShape "decay2"
